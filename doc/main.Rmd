...
For data1, Simrank correlation is better than other correlation.
...
For data2, Memory-Based Model (pearson, threshold=0.2) is better than Cluster Model.
Variance Weighting improve the performance for data1, while lower the performance for data2.The best threshold is 0.2 for both data sets.
