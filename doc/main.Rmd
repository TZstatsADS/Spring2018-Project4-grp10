...
```{r}
if(simweight & var_weight & simrank){
  #weight_pearson_1<-simweight(df_train1,"pearson")
  weight_spearman_1<-simweight(df_train1,"spearman")
  weight_pearson_2<-simweight(df_train2,"pearson")
  weight_spearman_2<-simweight(df_train2,"spearman")
...
paste0("By using variance weight with threshold ",k,", the expected utility of the ranked list is ",rank_score(pred_var_1,df_test1))
