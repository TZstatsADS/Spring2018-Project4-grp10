...
There are two evaluation methods we used. We used Ranked Scoring for evaluate dataset1, and MAE for evaluate dataset2. Here are the algorithm functions for these two evaluation methods. 
...
For data1, the Simrank correlation is better than other correlation.
...
For data2, the Memory-Based Model (pearson, threshold=0.2) is better than the Cluster Model.
The Variance Weighting improve the performance for data1, while lower the performance for data2. The best threshold is 0.2 for both data sets.
